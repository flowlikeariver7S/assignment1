...
public class assignment4Q3 {
    public static void main(String[] args)  {
        savingAccount syuvankarthick = new savingAccount(10,9000);
        syuvankarthick.deposit(-1);
        syuvankarthick.withdraw(9100);
        System.out.println(syuvankarthick .getBalance());
    }